...
export async function POST(req: Request, res: Response) {
  try {
    ...
    let output_units: outputUnits = await strict_output(
      "You are an AI capable of curating course content, coming up with relavant chapter titles and finding relavent youtube videos for each chapter",
      ...
      ),
      {
        ...
        chapters:
          "an array of chapters and each chapter should have a youtube_search_query and a chapter_title key in the JSON object",
      }
    )
